...
export default function Login() {
    ...
    const { isAuthenticated, loginWithGoogle, loginWithGithub, loginWithCredentials, isLoggingIn } = useAuth();
    ...
    const getErrorMessage = (error: string | null) => {
        switch (error) {
            ...
            case "no_email":
                return "Could not retrieve email from your account.";
            case "oauth_failed":
                return "Authentication failed. Please try again.";
            case "missing_code":
                return "Authentication was cancelled or failed.";
            default:
                return error ? "An error occurred during login." : null;
        }
    };
